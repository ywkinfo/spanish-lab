...
SOURCE_OUT = ROOT / 'images' / 'ep37-llamada-gripe-rechazo-source.png'
THUMB_REPO = ROOT / 'thumbs' / 'a2-ep37-llamada-gripe-rechazo.jpg'
THUMB_OUT = ROOT / 'output' / 'thumbs' / 'frases-a2-ep37-llamada-gripe-rechazo.jpg'
QA_OUT = ROOT / 'output' / 'qa' / 'llamada-gripe-rechazo' / 'thumbnail.jpg'
...
center_text(d, badge, 'Español A2 · Ep.37', font(25), fill=(255, 255, 255, 255))

# Main title: No puedo ir.
d.text((88, 208), 'No puedo', font=font(74), fill=(255, 255, 255, 255), stroke_width=6, stroke_fill=(18, 18, 18, 255))
d.text((90, 310), 'ir', font=font(74), fill=(255, 255, 255, 255), stroke_width=6, stroke_fill=(18, 18, 18, 255))

# Korean meaning pill: 아파서 못 가요.
pill_ko = (82, 448, 548, 518)
d.rounded_rectangle(pill_ko, radius=35, fill=(255, 255, 255, 250), outline=(16, 16, 16, 45), width=2)
center_text(d, pill_ko, '아파서 못 가요', font(35), fill=(24, 24, 24, 255))

# Teal learning-point pill: 전화 약속 거절.
pill_teal = (82, 548, 492, 608)
d.rounded_rectangle(pill_teal, radius=30, fill=(20, 150, 148, 255))
center_text(d, pill_teal, '전화 약속 거절', font(28), fill=(255, 255, 255, 255))
