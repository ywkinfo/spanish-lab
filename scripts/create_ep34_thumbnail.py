...
SOURCE_OUT = ROOT / 'images' / 'ep34-en-el-restaurante-pedir-source.png'
THUMB_REPO = ROOT / 'thumbs' / 'a2-ep34-en-el-restaurante-pedir.jpg'
THUMB_OUT = ROOT / 'output' / 'thumbs' / 'frases-a2-ep34-en-el-restaurante-pedir.jpg'
QA_OUT = ROOT / 'output' / 'qa' / 'en-el-restaurante-pedir' / 'thumbnail.jpg'
...
center_text(d, badge, 'Español A2 · Ep.34', font(25), fill=(255, 255, 255, 255))

# Main title: ¿Qué recomienda?.
d.text((88, 208), '¿Qué', font=font(74), fill=(255, 255, 255, 255), stroke_width=6, stroke_fill=(18, 18, 18, 255))
d.text((90, 310), 'recomienda?', font=font(74), fill=(255, 255, 255, 255), stroke_width=6, stroke_fill=(18, 18, 18, 255))

# Korean meaning pill: 어떤 걸 추천해요?.
pill_ko = (82, 448, 548, 518)
d.rounded_rectangle(pill_ko, radius=35, fill=(255, 255, 255, 250), outline=(16, 16, 16, 45), width=2)
center_text(d, pill_ko, '어떤 걸 추천해요', font(35), fill=(24, 24, 24, 255))

# Teal learning-point pill: 레스토랑 주문.
pill_teal = (82, 548, 492, 608)
d.rounded_rectangle(pill_teal, radius=30, fill=(20, 150, 148, 255))
center_text(d, pill_teal, '레스토랑 주문', font(28), fill=(255, 255, 255, 255))
