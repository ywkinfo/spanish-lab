...
SRC = Path('/opt/data/cache/images/openai_codex_gpt-image-2-medium_20260522_190155_76095d00.png')
SOURCE_OUT = ROOT / 'images' / 'ep22-siempre-tomo-cafe-source.png'
THUMB_REPO = ROOT / 'thumbs' / 'a1-ep22-siempre-tomo-cafe.jpg'
THUMB_OUT = ROOT / 'output' / 'thumbs' / 'frases-a1-ep22-siempre-tomo-cafe.jpg'
QA_OUT = ROOT / 'output' / 'qa' / 'siempre-tomo-cafe' / 'thumbnail.jpg'
...
# The generated source is 3:2-ish. Crop high enough to keep Jin's full head and coffee,
# while reducing tiny pseudo-text on bottom flashcards.
source16 = cover_crop(source_original, (W, H), focus=(0.52, 0.10))
...
# Sharp morning coffee scene on the right, faded into the left text area.
scene = cover_crop(source, (820, 720), focus=(0.82, 0.40)).convert('RGBA')
...
center_text(d, badge, 'Español A1+ · Ep.22', font(25), fill=(255, 255, 255, 255))

# Main title: one learning point visually dominant.
d.text((92, 206), 'Siempre', font=font(65), fill=(255, 255, 255, 255), stroke_width=5, stroke_fill=(18, 18, 18, 255))
d.text((94, 304), 'tomo café', font=font(43), fill=(255, 255, 255, 255), stroke_width=4, stroke_fill=(18, 18, 18, 255))
d.text((94, 356), 'por la mañana', font=font(38), fill=(255, 255, 255, 255), stroke_width=4, stroke_fill=(18, 18, 18, 255))

# Korean pill.
pill_ko = (82, 452, 538, 520)
d.rounded_rectangle(pill_ko, radius=34, fill=(255, 255, 255, 250), outline=(16, 16, 16, 45), width=2)
center_text(d, pill_ko, '항상 커피 마셔요', font(33), fill=(24, 24, 24, 255))

# Teal learning-point pill.
pill_teal = (82, 552, 370, 610)
d.rounded_rectangle(pill_teal, radius=29, fill=(20, 150, 148, 255))
center_text(d, pill_teal, '항상 = Siempre', font(28), fill=(255, 255, 255, 255))

# Footer note.
d.text((388, 567), 'Siempre + 현재형', font=font(23), fill=(78, 68, 58, 235))
