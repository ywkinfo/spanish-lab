...
SRC = Path('/opt/data/cache/images/openai_codex_gpt-image-2-medium_20260519_223714_2b20c7ee.png')
SOURCE_OUT = ROOT / 'images' / 'ep16-que-tiempo-hace-source.png'
THUMB_REPO = ROOT / 'thumbs' / 'a1-ep16-que-tiempo-hace.jpg'
THUMB_OUT = ROOT / 'output' / 'thumbs' / 'frases-a1-ep16-que-tiempo-hace.jpg'
QA_OUT = ROOT / 'output' / 'qa' / 'que-tiempo-hace' / 'thumbnail.jpg'
...
# Persist a 16:9 source image for the episode intro/background.
SOURCE_OUT.parent.mkdir(parents=True, exist_ok=True)
source_original = Image.open(SRC).convert('RGB')
source16 = cover_crop(source_original, (W, H), focus=(0.72, 0.50))
...
# Sharp weather scene on the right, with a soft fade into the left panel.
scene = cover_crop(source, (760, 720), focus=(0.84, 0.50)).convert('RGBA')
...
# Subtle dark gradient on the far left.
...
center_text(d, badge, 'Español A1 · Ep.16', font(26), fill=(255, 255, 255, 255))

# Main title.
main_f = font(62)
lines = ['¿Qué tiempo', 'hace?']
y = 223
for line in lines:
...
center_text(d, pill_ko, '오늘 날씨가 어때?', font(34), fill=(24, 24, 24, 255))

# Teal phrase pill.
pill_teal = (82, 525, 448, 586)
d.rounded_rectangle(pill_teal, radius=30, fill=(20, 150, 148, 255))
center_text(d, pill_teal, 'Hace sol ☀️', font(32), fill=(255, 255, 255, 255))

# Small weather accent dots.
for x, y, r, c in [(516, 135, 8, (255, 198, 88, 255)), (530, 157, 5, (255, 220, 135, 255)), (500, 585, 7, (105, 195, 215, 255))]:
