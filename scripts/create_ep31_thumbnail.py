...
SOURCE_OUT = ROOT / 'images' / 'ep31-mas-despacio-por-favor-source.png'
THUMB_REPO = ROOT / 'thumbs' / 'a1-ep31-mas-despacio-por-favor.jpg'
THUMB_OUT = ROOT / 'output' / 'thumbs' / 'frases-a1-ep31-mas-despacio-por-favor.jpg'
QA_OUT = ROOT / 'output' / 'qa' / 'mas-despacio-por-favor' / 'thumbnail.jpg'
...
center_text(d, badge, 'Español A1+ · Ep.31', font(25), fill=(255, 255, 255, 255))

# Main title: Más despacio.
d.text((88, 208), 'Más', font=font(74), fill=(255, 255, 255, 255), stroke_width=6, stroke_fill=(18, 18, 18, 255))
d.text((90, 310), 'despacio', font=font(74), fill=(255, 255, 255, 255), stroke_width=6, stroke_fill=(18, 18, 18, 255))

# Korean meaning pill: 천천히 말해주세요.
pill_ko = (82, 448, 548, 518)
d.rounded_rectangle(pill_ko, radius=35, fill=(255, 255, 255, 250), outline=(16, 16, 16, 45), width=2)
center_text(d, pill_ko, '천천히 말해주세요', font(35), fill=(24, 24, 24, 255))

# Teal learning-point pill: 원어민이 빠를 때.
pill_teal = (82, 548, 492, 608)
d.rounded_rectangle(pill_teal, radius=30, fill=(20, 150, 148, 255))
center_text(d, pill_teal, '원어민이 빠를 때', font(28), fill=(255, 255, 255, 255))
