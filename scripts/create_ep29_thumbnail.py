...
SRC_CACHE = Path('/opt/data/cache/images/openai_codex_gpt-image-2-medium_20260526_114503_10141bbc.png')
SOURCE_OUT = ROOT / 'images' / 'ep29-me-lo-llevo-source.png'
THUMB_REPO = ROOT / 'thumbs' / 'a1-ep29-me-lo-llevo.jpg'
THUMB_OUT = ROOT / 'output' / 'thumbs' / 'frases-a1-ep29-me-lo-llevo.jpg'
QA_OUT = ROOT / 'output' / 'qa' / 'me-lo-llevo' / 'thumbnail.jpg'
...
# Keep a canonical source image in the repo for later video production.
source_original = Image.open(SRC_CACHE).convert('RGB')
source16 = cover_crop(source_original, (W, H), focus=(0.50, 0.52))
...
base = cover_crop(source, (W, H), focus=(0.56, 0.48))
...
# Sharp souvenir-shop scene on the right, gently faded into the text panel.
scene = cover_crop(source, (860, 720), focus=(0.86, 0.48)).convert('RGBA')
...
center_text(d, badge, 'Español A1+ · Ep.29', font(25), fill=(255, 255, 255, 255))

# Main title.
d.text((88, 208), 'Me lo', font=font(74), fill=(255, 255, 255, 255), stroke_width=6, stroke_fill=(18, 18, 18, 255))
d.text((90, 310), 'llevo', font=font(74), fill=(255, 255, 255, 255), stroke_width=6, stroke_fill=(18, 18, 18, 255))

# Korean meaning pill.
pill_ko = (82, 448, 548, 518)
d.rounded_rectangle(pill_ko, radius=35, fill=(255, 255, 255, 250), outline=(16, 16, 16, 45), width=2)
center_text(d, pill_ko, '이걸로 할게요', font(35), fill=(24, 24, 24, 255))

# Teal learning-point pill.
pill_teal = (82, 548, 492, 608)
d.rounded_rectangle(pill_teal, radius=30, fill=(20, 150, 148, 255))
center_text(d, pill_teal, '쇼핑 스페인어', font(28), fill=(255, 255, 255, 255))
